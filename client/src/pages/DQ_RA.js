...
class DQ_RA extends React.Component {
  ...
  constructor(props) {
    ...
    this.items = [
      ...
            "Sustainability % Rank in Global Category",
            "Historical Sustainability Score",
            "Portfolio Sustainability Score",
            "Portfolio Environmental Score",
            "Portfolio Social Score",
    ...
    return (
      ...
      <Container>
        ...
        <Row className="mt-5">
          ...
          <Col md={3}>
            <Button variant="danger" onClick={this.handleDelShow}>
              Delete DQ Rule
      </Button>
          </Col>
        </Row>
