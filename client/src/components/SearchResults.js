...
class SearchResult extends React.Component {
   ...
   render() {
      ...
      <Button variant="info" size="sm" id={this.props.id} onClick={this.props.onClick} edit={this.props.isClicked} > Edit</Button>
           <Button variant="danger" size="sm" id={this.props.id} onClick={this.props.onClick} delete={this.props.isClicked} >Del</Button>
{/* 
